...
{% include updated_notice.html
    message='Inspired by this post, <a href="https://twitter.com/leemorgan">Lee Morgan</a> has written a build script that generates a Swift source file based on Xcode assets. Checkout the repo <a href="https://github.com/leemorgan/AutoAssets">AutoAssets</a> on GitHub. Thanks Lee!'
%}
