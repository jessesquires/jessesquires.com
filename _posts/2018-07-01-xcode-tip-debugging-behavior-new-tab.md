...
Previously, I [discussed]({{ site.url }}/blog/xcode-tip-improving-assistant-editor/) how to make Xcode's 'Assistant Editor' less frustrating when writing Swift. Another trick I learned recently involves using Xcode Behaviors to improve the debugging experience.
