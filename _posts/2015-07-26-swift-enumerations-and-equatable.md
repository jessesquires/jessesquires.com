...
message='As of Swift 4.1 (proposal <a href="https://github.com/apple/swift-evolution/blob/main/proposals/0185-synthesize-equatable-hashable.md">SE-0185</a>) the compiler will synthesize <code>Equatable</code> conformance for you. Associated values will also need to conform to <code>Equatable</code>.'
%}
